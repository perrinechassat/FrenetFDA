...
print(" Scenario 3, simu 3")

filename = filename_base + "simu_3_"

filename_simu_Q = "/home/pchassat/FrenetFDA/Simulations_TwoStepEstimation/results/scenario2/model_04/simu_3"
