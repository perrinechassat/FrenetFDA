...
import pandas as pd
import numpy as np
from utils_functions import estimation_extrinsic_formulas
...
print('Start: Estimation curvatures with extrinsic formulas', '\n')

filename = filename_base + "estimates_extrinsic_formulas"
estimation_extrinsic_formulas(filename, list_Y, n_call_bayopt_der, bounds_h_der, bounds_lbda, n_call_bayopt_theta)

print('End: Estimation curvatures with extrinsic formulas.', '\n')
