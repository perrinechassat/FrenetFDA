...
group = ['bouche bée', 'donner', 'avoir', 'bonjour', 'bouche cousue', 'brosse à dent', 'cerise', 'chaud', 'commander(resto)'] #93
...
filename = filename_base + "estimates_GS_least_squares_group_3"
