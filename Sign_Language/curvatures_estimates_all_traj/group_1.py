...
group = ["faire l'amour", 'coiffer', 'Dimanche', 'ne pas aimer', 'Toujours', 'Autrefois', 'avril', 'train', "avoir l'air"] #93
...
filename = filename_base + "estimates_GS_least_squares_group_1"
