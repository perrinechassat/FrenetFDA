...
Scenario 4: Simulation code to compare the results in function of the number of sample points. 
    ...
    Scenario:
        1. N = 200  gamma = 0.001  (same as Scenario 3.1)
        2. N = 100  gamma = 0.001
        3. N = 200  gamma = 0.005  (same as Scenario 3.2)
        4. N = 100  gamma = 0.005
    and all the others parameters are the same for all scenarios.
...
filename = filename_base + "model"
dic = {"nb_iterations_simu": N_simu, "P0": P0, "mu0": mu0, "theta":theta, "Sigma":Sigma, "reg_param_grid_EM":reg_param_grid_EM, "max_iter":max_iter, "tol":tol, 
...
dic = {"results_S4_2":res_S4_2, "N": N, "nb_basis": nb_basis, "gamma":gamma}
...
filename = filename_base + "scenario_4_4"

dic = {"results_S4_4":res_S4_4, "N": N, "nb_basis": nb_basis, "gamma":gamma}
...
print('End of scenario 4.4: time spent', duration, 'seconds. \n')