...
bounds_lambda = ((-9, -3), (-9, -3))
sigma_init = 0.1

print(" Influence init, simu 1")

filename = filename_base + "simu_1_bis"

filename_simu = "/home/pchassat/FrenetFDA/Simulations_TwoStepEstimation/results/scenario2/model_05/simu_1"
